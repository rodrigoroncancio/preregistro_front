...
// node_modules/vue-picture-cropper/lib/index.mjs
function Hi(e, i) {
  var a = Object.keys(e);
...
function pt(e) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    i % 2 ? Hi(Object(a), true).forEach(function(t) {
      St(e, t, a[t]);
...
function qi(e, i) {
  for (var a = 0; a < i.length; a++) {
    var t = i[a];
    t.enumerable = t.enumerable || false, t.configurable = true, "value" in t && (t.writable = true), Object.defineProperty(e, st(t.key), t);
  }
}
function Nt(e, i, a) {
...
var hi = typeof window < "u" && typeof window.document < "u";
var B = hi ? window : {};
var Ai = hi && B.document.documentElement ? "ontouchstart" in B.document.documentElement : false;
var Ti = hi ? "PointerEvent" in B : false;
var w = "cropper";
var Oi = "all";
var ct = "crop";
var lt = "move";
...
var ni = "se";
var oi = "sw";
var yi = "".concat(w, "-crop");
var Yi = "".concat(w, "-disabled");
var T = "".concat(w, "-hidden");
var Wi = "".concat(w, "-hide");
var Pt = "".concat(w, "-invisible");
var mi = "".concat(w, "-modal");
var ki = "".concat(w, "-move");
var ri = "".concat(w, "Action");
var li = "".concat(w, "Preview");
var Ni = "crop";
var mt = "move";
var ht = "none";
var Di = "crop";
...
var zi = "cropstart";
var Ui = "dblclick";
var Xt = Ai ? "touchstart" : "mousedown";
var Ht = Ai ? "touchmove" : "mousemove";
var qt = Ai ? "touchend touchcancel" : "mouseup";
var Vi = Ti ? "pointerdown" : Xt;
var $i = Ti ? "pointermove" : Ht;
var Gi = Ti ? "pointerup pointercancel" : qt;
var Fi = "ready";
var Qi = "resize";
var Zi = "wheel";
var ji = "zoom";
var Ki = "image/jpeg";
var Yt = /^e|w|s|n|se|sw|ne|nw|all|crop|move|zoom$/;
var Wt = /^data:/;
var Ut = /^data:image\/jpeg;base64,/;
var Vt = /^img|canvas$/i;
var vt = 200;
var ft = 100;
var Ji = {
...
function ti(e, i, a) {
  ...
  return A(Event) && A(CustomEvent) ? t = new CustomEvent(i, {
    ...
    bubbles: true,
    cancelable: true
  }) : (t = document.createEvent("CustomEvent"), t.initCustomEvent(i, true, true, a)), e.dispatchEvent(t);
}
function bt(e) {
...
var ha = {
  ...
  initCanvas: function() {
    ...
    this.canvasData = r, this.limited = t === 1 || t === 2, this.limitCanvas(true, true), r.width = Math.min(Math.max(r.width, r.minWidth), r.maxWidth), r.height = Math.min(Math.max(r.height, r.minHeight), r.maxHeight), r.left = (i.width - r.width) / 2, r.top = (i.height - r.height) / 2, r.oldLeft = r.left, r.oldTop = r.top, this.initialCanvasData = y({}, r);
  },
  ...
  renderCanvas: function(i, a) {
    ...
    if (a) {
      ...
      t.left -= (m - t.width) / 2, t.top -= (l - t.height) / 2, t.width = m, t.height = l, t.aspectRatio = p / c, t.naturalWidth = p, t.naturalHeight = c, this.limitCanvas(true, false);
    }
    (t.width > t.maxWidth || t.width < t.minWidth) && (t.left = t.oldLeft), (t.height > t.maxHeight || t.height < t.minHeight) && (t.top = t.oldTop), t.width = Math.min(Math.max(t.width, t.minWidth), t.maxWidth), t.height = Math.min(Math.max(t.height, t.minHeight), t.maxHeight), this.limitCanvas(false, true), t.left = Math.min(Math.max(t.left, t.minLeft), t.maxLeft), t.top = Math.min(Math.max(t.top, t.minTop), t.maxTop), t.oldLeft = t.left, t.oldTop = t.top, Y(this.canvas, y({
      width: t.width,
      height: t.height
    }, pi({
      translateX: t.left,
      translateY: t.top
    }))), this.renderImage(i), this.cropped && this.limited && this.limitCropBox(true, true);
  },
  ...
  renderCropBox: function() {
    ...
    (t.width > t.maxWidth || t.width < t.minWidth) && (t.left = t.oldLeft), (t.height > t.maxHeight || t.height < t.minHeight) && (t.top = t.oldTop), t.width = Math.min(Math.max(t.width, t.minWidth), t.maxWidth), t.height = Math.min(Math.max(t.height, t.minHeight), t.maxHeight), this.limitCropBox(false, true), t.left = Math.min(Math.max(t.left, t.minLeft), t.maxLeft), t.top = Math.min(Math.max(t.top, t.minTop), t.maxTop), t.oldLeft = t.left, t.oldTop = t.top, i.movable && i.cropBoxMovable && si(this.face, ri, t.width >= a.width && t.height >= a.height ? lt : Oi), Y(this.cropBox, y({
      width: t.width,
      height: t.height
    }, pi({
      translateX: t.left,
...
var ua = {
  ...
  wheel: function(i) {
    ...
    this.disabled || (i.preventDefault(), !this.wheeling && (this.wheeling = true, setTimeout(function() {
      a.wheeling = false;
  ...
  cropStart: function(i) {
    ...
    (u(a) && a !== 1 || u(t) && t !== 0 || i.ctrlKey))) {
      ...
      i.changedTouches ? D(i.changedTouches, function(c) {
        ...
        originalEvent: i,
        action: p
      }) !== false && (i.preventDefault(), this.action = p, this.cropping = false, p === ct && (this.cropping = true, j(this.dragBox, mi)));
    }
  },
  cropMove: function(i) {
    var a = this.action;
    if (!(this.disabled || !a)) {
      ...
      i.preventDefault(), ti(this.element, Mi, {
        originalEvent: i,
        action: a
      }) !== false && (i.changedTouches ? D(i.changedTouches, function(o) {
        y(t[o.identifier] || {}, di(o, true));
      }) : y(t[i.pointerId || 0] || {}, di(i, true)), this.change(i));
    }
  },
  cropEnd: function(i) {
    if (!this.disabled) {
      ...
      }) : delete t[i.pointerId || 0], a && (i.preventDefault(), Object.keys(t).length || (this.action = ""), this.cropping && (this.cropping = false, J(this.dragBox, mi, this.cropped && this.options.modal)), ti(this.element, Ei, {
        originalEvent: i,
        action: a
      }));
    }
...
var ga = {
  change: function(i) {
    var a = this.options, t = this.canvasData, o = this.containerData, n = this.cropBoxData, p = this.pointers, c = this.action, m = a.aspectRatio, l = n.left, r = n.top, s = n.width, d = n.height, v = l + s, f = r + d, b = 0, g = 0, E = o.width, z = o.height, k = true, P;
    ...
    switch (c) {
      ...
      case ai:
        if (m) {
          ...
          x(q), x(G), h.x >= 0 ? v < E ? s += h.x : h.y <= 0 && r <= g && (k = false) : s += h.x, h.y <= 0 ? r > g && (d -= h.y, r += h.y) : (d -= h.y, r += h.y);
      ...
      case ei:
        if (m) {
          ...
          x(q), x(F), h.x <= 0 ? l > b ? (s -= h.x, l += h.x) : h.y <= 0 && r <= g && (k = false) : (s -= h.x, l += h.x), h.y <= 0 ? r > g && (d -= h.y, r += h.y) : (d -= h.y, r += h.y);
      ...
      case oi:
        if (m) {
          ...
          x(Z), x(F), h.x <= 0 ? l > b ? (s -= h.x, l += h.x) : h.y >= 0 && f >= z && (k = false) : (s -= h.x, l += h.x), h.y >= 0 ? f < z && (d += h.y) : d += h.y;
      ...
      case ni:
        if (m) {
          ...
          x(Z), x(G), h.x >= 0 ? v < E ? s += h.x : h.y >= 0 && f >= z && (k = false) : s += h.x, h.y >= 0 ? f < z && (d += h.y) : d += h.y;
        s < 0 && d < 0 ? (c = ei, d = -d, s = -s, r -= d, l -= s) : s < 0 ? (c = oi, s = -s, l -= s) : d < 0 && (c = ai, d = -d, r -= d);
        break;
      case lt:
        this.move(h.x, h.y), k = false;
        break;
      case dt:
        this.zoom(ea(p), i), k = false;
        break;
      case ct:
        if (!h.x || !h.y) {
          k = false;
        ...
        P = bt(this.cropper), l = O.startX - P.left, r = O.startY - P.top, s = n.minWidth, d = n.minHeight, h.x > 0 ? c = h.y > 0 ? ni : ai : h.x < 0 && (l -= s, c = h.y > 0 ? oi : ei), h.y < 0 && (r -= d), this.cropped || (L(this.cropBox, T), this.cropped = true, this.limited && this.limitCropBox(true, true));
        break;
    }
...
var xa = {
  ...
  crop: function() {
    return this.ready && !this.cropped && !this.disabled && (this.cropped = true, this.limitCropBox(true, true), this.options.modal && j(this.dragBox, mi), L(this.cropBox, T), this.setCropBoxData(this.initialCropBoxData)), this;
  },
  ...
  clear: function() {
    return this.cropped && !this.disabled && (y(this.cropBoxData, {
      ...
      width: 0,
      height: 0
    }), this.cropped = false, this.renderCropBox(), this.limitCanvas(true, true), this.renderCanvas(), L(this.dragBox, mi), j(this.cropBox, T)), this;
  },
  /**
  ...
  replace: function(i) {
    ...
    }))) : (this.isImg && (this.replaced = true), this.options.data = null, this.uncreate(), this.load(i))), this;
  },
  // Enable (unfreeze) the cropper
  enable: function() {
    return this.ready && this.disabled && (this.disabled = false, L(this.cropper, Yi)), this;
  },
  // Disable (freeze) the cropper
  disable: function() {
    return this.ready && !this.disabled && (this.disabled = true, j(this.cropper, Yi)), this;
  },
  /**
   ...
   */
  moveTo: function(i) {
    var a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : i, t = this.canvasData, o = false;
    return i = Number(i), a = Number(a), this.ready && !this.disabled && this.options.movable && (u(i) && (t.left = i, o = true), u(a) && (t.top = a, o = true), o && this.renderCanvas(true)), this;
  },
  /**
  ...
  zoomTo: function(i, a, t) {
    ...
    if (i = Number(i), i >= 0 && this.ready && !this.disabled && o.zoomable) {
      ...
      n.width = r, n.height = s, this.renderCanvas(true);
    }
    return this;
  },
  /**
   ...
   */
  rotateTo: function(i) {
    return i = Number(i), u(i) && this.ready && !this.disabled && this.options.rotatable && (this.imageData.rotate = i % 360, this.renderCanvas(true, true)), this;
  },
  /**
   ...
   */
  scale: function(i) {
    var a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : i, t = this.imageData, o = false;
    return i = Number(i), a = Number(a), this.ready && !this.disabled && this.options.scalable && (u(i) && (t.scaleX = i, o = true), u(a) && (t.scaleY = a, o = true), o && this.renderCanvas(true, true)), this;
  },
  /**
   ...
   */
  getData: function() {
    var i = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, a = this.options, t = this.imageData, o = this.canvasData, n = this.cropBoxData, p;
  ...
  setData: function(i) {
    ...
    if (this.ready && !this.disabled && K(i)) {
      var p = false;
      a.rotatable && u(i.rotate) && i.rotate !== t.rotate && (t.rotate = i.rotate, p = true), a.scalable && (u(i.scaleX) && i.scaleX !== t.scaleX && (t.scaleX = i.scaleX, p = true), u(i.scaleY) && i.scaleY !== t.scaleY && (t.scaleY = i.scaleY, p = true)), p && this.renderCanvas(true, true);
      var c = t.width / t.naturalWidth;
  ...
  setCanvasData: function(i) {
    ...
    return this.ready && !this.disabled && K(i) && (u(i.left) && (a.left = i.left), u(i.top) && (a.top = i.top), u(i.width) ? (a.width = i.width, a.height = i.width / t) : u(i.height) && (a.height = i.height, a.width = i.height * t), this.renderCanvas(true)), this;
  },
  /**
  ...
  setCropBoxData: function(i) {
    ...
    return this.ready && this.cropped && !this.disabled && K(i) && (u(i.left) && (a.left = i.left), u(i.top) && (a.top = i.top), u(i.width) && i.width !== a.width && (o = true, a.width = i.width), u(i.height) && i.height !== a.height && (n = true, a.height = i.height), t && (o ? a.height = a.width / t : n && (a.width = a.height * t)), this.renderCropBox()), this;
  },
  /**
  ...
  getCroppedCanvas: function() {
    ...
    var z = i.imageSmoothingEnabled, k = z === void 0 ? true : z, P = i.imageSmoothingQuality;
...
var yt = function() {
  function e(i) {
    ...
    this.element = i, this.options = y({}, Ji, K(a) && a), this.cropped = false, this.disabled = false, this.pointers = {}, this.ready = false, this.reloading = false, this.replaced = false, this.sized = false, this.sizing = false, this.init();
  }
  return Nt(e, [{
    key: "init",
    value: function() {
      ...
      if (!a[w]) {
        if (a[w] = this, t === "img") {
          if (this.isImg = true, o = a.getAttribute("src") || "", this.originalUrl = o, !o)
            return;
          o = a.src;
        } else
    ...
    value: function(a) {
      ...
      if (a) {
        ...
        if (!n.rotatable && !n.scalable && (n.checkOrientation = false), !n.checkOrientation || !window.ArrayBuffer) {
          this.clone();
          return;
        }
        if (Wt.test(a)) {
        ...
        this.reloading = true, this.xhr = p, p.onabort = c, p.onerror = c, p.ontimeout = c, p.onprogress = function() {
          p.getResponseHeader("content-type") !== Ki && p.abort();
        }, p.onload = function() {
          t.read(p.response);
        }, p.onloadend = function() {
          t.reloading = false, t.xhr = null;
        }, n.checkCrossOrigin && tt(a) && o.crossOrigin && (a = at(a)), p.open("GET", a, true), p.responseType = "arraybuffer", p.withCredentials = o.crossOrigin === "use-credentials", p.send();
      }
    }
  }, {
    key: "read",
    ...
    value: function() {
      ...
      t.onload = null, t.onerror = null, this.sizing = true;
      var o = B.navigator && /(?:iPad|iPhone|iPod).*?AppleWebKit/i.test(B.navigator.userAgent), n = function(l, r) {
        y(a.imageData, {
          naturalWidth: l,
          naturalHeight: r,
          aspectRatio: l / r
        }), a.initialImageData = y({}, a.imageData), a.sizing = false, a.sized = true, a.build();
      };
      if (t.naturalWidth && !o) {
  ...
  return new Promise((t, o) => {
    ...
    switch (e) {
      case "js": {
        ...
        p.async = true, p.src = a, n(p), document.head.appendChild(p);
        break;
      }
      case "css": {
...
function nt(e) {
  ...
  return i.width = t, i.height = o, a.imageSmoothingEnabled = true, a.drawImage(e, 0, 0, t, o), a.globalCompositeOperation = "destination-in", a.beginPath(), a.arc(
    t / 2,
    o / 2,
    Math.min(t, o) / 2,
    0,
...
`;
var Na = `.vue--picture-cropper__wrap{width:100%;height:100%;margin:0}.vue--picture-cropper__img{display:block;width:auto;height:auto;max-width:100%;max-height:100%}.vue--picture-cropper__wrap-round .cropper-view-box,.vue--picture-cropper__wrap-round .cropper-face{border-radius:50%}
`;
Et({
  type: "style",
  id: "cropperjs",
...
vue-picture-cropper/lib/index.mjs:
  (*!
   * Cropper.js v1.6.1
   * https://fengyuanchen.github.io/cropperjs
   *
   ...
   *)
*/
//# sourceMappingURL=vue-picture-cropper.js.map
