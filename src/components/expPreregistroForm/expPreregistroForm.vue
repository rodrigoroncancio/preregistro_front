...
<script setup lang="ts">
  ...
  survey.onCompleting.add((sender, options) => {
    ...
    const predioLoteViveData = {
      ...
      vereda: sender.data.vive_lugar === "4" ? sender.data.vive_vereda_otra : null,
      direccion: sender.data.vive_direccion != null ? sender.data.vive_direccion : 'Sin dirección',
      nombre_lugar: 'Sin nombre',
      residencia: 1,
    ...
    const predioLoteDesplazadoData = {
      ...
      vereda: sender.data.deplazado_lugar === "4" ? sender.data.desplazado_otra_vereda : null,
    ...
    const predioLoteCocaOtroData = {
      ...
      vereda: sender.data.predio_coca_otro_lugar === "4" ? sender.data.predio_coca_otro_vereda_otra : null,
