            ...
            <v-col>
              ...
              <div className="main-content">
                <h1 >
                  ...
                  <span className="title-highlight-argelia">Tumaco</span>
                </h1>
          ...
          <v-row>
            <v-col>
              <div className="buttons-container-argelia-page">
                ...
                <div className="button-group-argelia-page">
                  <a href="/narino/tumaco/preregistro" target="blank" className="btn-arge-page blue">Preregistro de núcleos de familiares</a>
