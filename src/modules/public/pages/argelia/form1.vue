...
<script setup lang="ts">
        ...
        },
        {
          ...
          "elements": [
            ...
            },
            {
              ...
              "choices": [
                {
                  "value": "Comunidad indígena sin territorio formalmente constituido",
                  "text": "Comunidad indígena sin territorio formalmente constituido"
                },
                {
                  "value": "Asociación de comunidad negra sin territorio formalmente titulado",
                  "text": "Asociación de comunidad negra sin territorio formalmente titulado"
                },
                {
                  "value": "Consejo Comunitario formalmente titulado",
                  "text": "Consejo Comunitario formalmente titulado"
                },
                {
                  "value": "Resguardo",
                  "text": "Resguardo"
                ...
                {
                  "value": "Zona de Reserva Campesina",
                  "text": "Zona de Reserva Campesina"
                },
                {
          ...
          "elements": [
            ...
            },
            {
              ...
              "choices": [
                ...
                {
                  "value": "Documento compraventa",
                  "text": "Documento compraventa"
                }
              ]
            },
            {
  ...
  survey.onCompleting.add((sender, options) => {
      ...
      const senderData = {
        ...
        // documento_pertenencia_etnica_file: Array.isArray(sender.data.documento_pertenencia_etnica_file) && sender.data.predio10_arraigo_documento_soporte.length > 0 ? sender.data.documento_pertenencia_etnica_file[0].content : ""
      };
