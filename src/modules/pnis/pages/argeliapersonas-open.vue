...
const formSchema = computed(() => [
  ...
  { key: "madrecabezafamilia", type: "select", items: itemsMotherHeadOfHousehold, col: "md-6", title: "Madre Cabeza de Familia", required: true },
  ...
  { key: "telefono", type: "text", col: "md-6", title: "Teléfono", required: true },
  { key: "correo", type: "text", col: "md-6", title: "Correo", required: true },
  ...
  { key: "descripcionacceso", type: "text", col: "md-6", title: "Descripción del Acceso" },
  ...
  { key: "residenciapredio", type: "text", col: "md-6", title: "Residencia Predio" },
