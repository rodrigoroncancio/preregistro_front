...
const uCrud = useCrud(`${endpoint}/argeliapersonas`);
...
const formSchema = computed(() => [
  { key: "__id", type: "text", col: "md-6", title: "ID", required: true },
  { key: "submissiondate", type: "date", col: "md-6", title: "Fecha de Envío" },
  { key: "updatedat", type: "date", col: "md-6", title: "Última Actualización" },
  { key: "submitterid", type: "text", col: "md-6", title: "ID del Remitente" },
  { key: "submittername", type: "text", col: "md-6", title: "Nombre del Remitente" },
  { key: "attachmentspresent", type: "text", col: "md-6", title: "Adjuntos Presentes" },
  { key: "attachmentsexpected", type: "text", col: "md-6", title: "Adjuntos Esperados" },
  ...
  { key: "edits", type: "number", col: "md-6", title: "Ediciones" },
  { key: "formversion", type: "text", col: "md-6", title: "Versión del Formulario" },
  { key: "nota1", type: "text", col: "md-6", title: "Nota 1" },
  { key: "nota2", type: "text", col: "md-6", title: "Nota 2" },
  ...
  { key: "experiencia_linea_productiva_anos", type: "number", col: "md-6", title: "Años de Experiencia Línea Productiva" },
  { key: "nota3", type: "text", col: "md-6", title: "Nota 3" },
  { key: "fecha", type: "date", col: "md-6", title: "Fecha" },
  { key: "grupo_productores", type: "text", col: "md-6", title: "Grupo de Productores" },
  ...
  { key: "nota4", type: "text", col: "md-6", title: "Nota 4" },
  ...
  { key: "nota5", type: "text", col: "md-6", title: "Nota 5" },
  { key: "departamento", type: "text", col: "md-6", title: "Departamento" },
  { key: "municipio", type: "text", col: "md-6", title: "Municipio" },
  { key: "numero_familias_grupo_productores", type: "number", col: "md-6", title: "Número de Familias del Grupo" },
  { key: "nota6", type: "text", col: "md-6", title: "Nota 6" },
  { key: "instanceid", type: "text", col: "md-6", title: "ID de la Instancia" }
]);
