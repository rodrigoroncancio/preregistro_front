...
const uCrud = useCrud(`${endpoint}/catatumbogrupos`);
...
const formSchema = computed(() => [
  ...
  { key: "experiencia_linea_productiva_no_agropecuaria", type: "text", col: "md-6", title: "Experiencia Línea Productiva no agropecuaria" },
  { key: "experiencia_linea_productiva_anos_no_agropecuaria", type: "number", col: "md-6", title: "Años de Experiencia Línea Productiva no Agropecuario" },
  { key: "linea_productiva_fortalecimiento", type: "text", col: "md-6", title: "Línea Productiva fortelecimiento" },
  { key: "linea_productiva_fortalecimiento_cual", type: "text", col: "md-6", title: "Línea Productiva fortelecimiento Otra" },
  { key: "victima_posterior_2025", type: "text", col: "md-6", title: "Victima posterior 2025" },
...
onMounted(async () => {
  ...
  if (surveyId != null) {
    ...
    const response = await axios.get(`${endpoint}/catatumbogrupos/${surveyId}/`)
